...
export function CartProvider({ children }: CartProviderProps): JSX.Element {
  ...
  const prevCartPrev = useRef<Product[]>();

  // Verifico o valor anterior do carrinho
  useEffect(() => {
    prevCartPrev.current = cart;
  });

  // Comparo com o atual
  const cartPreviousValue = prevCartPrev.current ?? cart;

  // Se mudou eu seto no localStorage, olhando apenas cart e cartPrevValue
  useEffect(() => {
